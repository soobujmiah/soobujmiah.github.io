...
if (!nameComp) {
  ...
  /* Sampling must stay budget-aware and particulate. Accept either the
     classic step adapters or the min-distance visual-weight sampler. */
  if (!/(sampleStepFor|denseStepFor|sampleInkPointsMinDist)\(/.test(nameComp)) {
